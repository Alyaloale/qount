...
daily snapshot log) lives in ``scripts/research/x4_paper.py``.
"""
...
from qount.x4.backtest import max_drawdown, run_directional, run_grid
from qount.x4.portfolio import combine, sharpe_of
