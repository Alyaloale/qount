...
``docs/archive/legacy/restart-lines/l3-information-edge-plan.md``: swap the information source from price/volume
...
from qount.strategy_selection import pearson_correlation
from qount.strategy_selection import spearman_rank_correlation
from qount.trade_policy import timeframe_to_ms
