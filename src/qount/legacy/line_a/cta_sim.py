...
This is the Phase 0 deliverable of ``docs/archive/legacy/line-a/rebuild-plan.md``. It wires the whole
...
class SimConfig:
    ...
    # Valuation filter (V-GATE, docs/archive/legacy/line-a/cta-r-value-gate-plan.md). Default OFF -> byte-identical
