...
from qount.research_data.indicators import ATR  # vol-parity sizing: ATR(14) per coin (mirror run_directional)
from qount.legacy.x4.portfolio import correlation  # §21.4 D correlation penalty (reuse engine's helper)
