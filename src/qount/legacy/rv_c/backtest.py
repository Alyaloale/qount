...
* **Roll** every quarter (``is_roll`` from :func:`qount.legacy.rv_c.basis.build_active_series`): the
...
class BasisResult:
    ...
    pre-registered criteria (``docs/archive/legacy/x4-rv/rv-c-plan.md`` §3) must survive.
    """
