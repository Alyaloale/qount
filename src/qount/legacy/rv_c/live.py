...
The validated edge (``docs/archive/legacy/x4-rv/rv-c-plan.md`` §7): **long spot + short the active dated quarterly
...
calendar (:func:`qount.legacy.rv_c.basis.active_expiry`, :func:`qount.legacy.rv_c.data.quarterly_contracts`).
"""
...
from qount.legacy.rv_c.data import dated_symbol, expiry_ms as _expiry_ms, quarterly_contracts
