...
当前源码版本为 `0.2.11`（独立freshness最终修复发布候选）；VPS 已验证部署 `0.2.10`，且
...
恢复前必须通过 `0.2.11` provenance、通知库迁移、无订单周期、readiness 五轴、账本和对账验收。首次live cycle因冻结信号
...
MiniTrend Base minimal-live，当前因0.2.11升级维护停盘。Dashboard静态前端已部署，
