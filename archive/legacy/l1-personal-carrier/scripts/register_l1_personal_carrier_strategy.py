#!/usr/bin/env python3
"""Publish the frozen L1-S2 sleeve into the standard research strategy registry."""
...
from qount.strategies import personal_carrier_strategy_registration  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    source_files = (
        ROOT / "src" / "qount" / "l1_personal_carrier_recertification.py",
        ROOT / "src" / "qount" / "strategies" / "personal_carrier.py",
    )
