...
def _family_records() -> dict[str, ResearchEvidenceReadinessRecord]:
    ...
    cxd_sources = _source_hashes(
        "docs/crypto-x4-plan.md",
        "docs/rv-c-plan.md",
        "src/qount/x4/combo.py",
        "scripts/research/x4_combo.py",
    )
    cta_sources = _source_hashes(
        "docs/rebuild-plan.md",
        "src/qount/l1_cross_asset.py",
        "src/qount/cta_sim.py",
    )
    return {
...
def _lifecycle_records() -> dict[str, ResearchEvidenceReadinessRecord]:
    ...
    return {
        ...
        "cta_r_lifecycle": ResearchEvidenceReadinessRecord.create(
            ...
            status="partial",
            available_evidence={
                "static_research_universe_source": "src/qount/l1_cross_asset.py",
                "future_membership_backfill_forbidden": True,
            },
            missing_evidence={
            ...
            source_hashes={
                **contract_sources,
                **_source_hashes("src/qount/l1_cross_asset.py"),
            },
            supports_research=True,
            supports_candidate_pnl=False,
        ),
    ...
    return {
        "cxd_cost": ResearchEvidenceReadinessRecord.create(
            ...
            source_hashes=_source_hashes(
                "scripts/research/x4_combo.py",
                "src/qount/x4/backtest.py",
                "src/qount/rv/backtest.py",
            ),
            supports_research=True,
            supports_candidate_pnl=False,
        ),
