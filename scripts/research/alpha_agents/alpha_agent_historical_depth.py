#!/usr/bin/env python3
"""Build checksum-verified Binance USD-M aggregate bookDepth 5m features."""
...
from qount.alpha_agents.historical_depth import HistoricalDepthConfig  # noqa: E402
from qount.alpha_agents.historical_depth import build_historical_depth_dataset  # noqa: E402
from qount.alpha_agents.historical_depth import write_historical_depth_artifact  # noqa: E402
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--cache-dir", default="state/alpha_agents/binance_historical_depth")
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = build_historical_depth_dataset(
    ...
    artifact = write_historical_depth_artifact(
